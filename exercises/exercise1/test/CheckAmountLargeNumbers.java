...
public class CheckAmountLargeNumbers {
	...
	public void CheckAmountTestThousandsWithWholeGroupZeroed()
		...
		assertEquals("Two thousand and 04/100 dollars", checkAmount.toString());
	}
	...
	public void CheckAmountTestMillionsWithTwoGroupsZeroed()
		...
		assertEquals("Three million and 04/100 dollars", checkAmount.toString());
	}
	...
	@Test
	public void CheckAmountUpperLimit() throws NumberTooLargeException {
		checkAmount.setValue("999999999999999999999999999999999.99");
		assertEquals("Nine hundred ninety-nine nonillion "
	...
	@Test
	public void CheckAmountOutOfBoundsTriggersException() {
		try {
			checkAmount.setValue("9901231000342319234211000000368548.99");
			fail();
	...
	@Test
	public void CheckAmountOutOfBoundsTriggersExceptionWhenNegative() {
		try {
			checkAmount.setValue("-9901231000342319234211000000368548.99");
			fail();
